...
- (void)filterInit {
    ...
    NSString *imagePath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"image01.jpg"];
...
- (void)setupSplitScreen_2ShaderProgram {
    [self setupShaderProgramWidthName:@"SplitScreen_2"];
}

// 四屏滤镜着色器程序
- (void)setupSplitScreen_4ShaderProgram {
    [self setupShaderProgramWidthName:@"SplitScreen_4"];
}

// 九屏滤镜着色器程序
- (void)setupSplitScreen_9ShaderProgram {
    [self setupShaderProgramWidthName:@"SplitScreen_9"];
}
